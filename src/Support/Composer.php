...
class Composer
{
     ...
     *
     * @var \Ugarit\Installer\Console\Support\Filesystem
     */
    protected $files;
     ...
     *
     * @param  \Ugarit\Installer\Console\Support\Filesystem  $files
    ...
    {
        $command = array_merge($this->findComposer($composerBinary), ['require'], $packages);
    ...
    {
        $command = array_merge($this->findComposer($composerBinary), ['remove'], $packages);
