...
namespace Heritage\Contracts\Database;
...
class ModelIdentifier
{
     ...
     *
     * @var class-string<\Heritage\Database\Eloquent\Model>|string|null
     */
    public $class;
     ...
     *
     * @var class-string<\Heritage\Database\Eloquent\Collection>|null
     */
     ...
     *
     * @param  class-string<\Heritage\Database\Eloquent\Model>|null  $class
     * @param  mixed  $id
     ...
     *
     * @param  class-string<\Heritage\Database\Eloquent\Collection>|null  $collectionClass
     * @return $this
     */
     ...
     *
     * @return class-string<\Heritage\Database\Eloquent\Model>|null
     */
