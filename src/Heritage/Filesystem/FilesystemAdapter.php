...
use Heritage\Contracts\Filesystem\Cloud as CloudFilesystemContract;
use Heritage\Contracts\Filesystem\Factory as FilesystemFactory;
use Heritage\Contracts\Filesystem\Filesystem as FilesystemContract;
use Heritage\Http\File;
use Heritage\Http\Request;
use Heritage\Http\UploadedFile;
use Heritage\Image\Image;
...
class FilesystemAdapter implements CloudFilesystemContract
{
     ...
     *
     * @param  string  $path
     * @param  \Psr\Http\Message\StreamInterface|\Heritage\Http\File|\Heritage\Http\UploadedFile|string|resource  $contents
     * @param  mixed  $options
     * @return string|bool
     */
     ...
     *
     * @param  \Heritage\Http\File|\Heritage\Http\UploadedFile|string  $path
     * @param  \Heritage\Http\File|\Heritage\Http\UploadedFile|string|array|null  $file
     * @param  mixed  $options
     * @return string|false
     */
     ...
     *
     * @param  string|\Heritage\Contracts\Filesystem\Filesystem  $disk
     * @param  string  $from
