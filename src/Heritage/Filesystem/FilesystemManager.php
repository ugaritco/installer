...
use Aws\S3\S3Client;
use Closure;
use Heritage\Contracts\Filesystem\Factory as FactoryContract;
use Heritage\Support\Arr;
use Heritage\Support\RebindsCallbacksToSelf;
...
/**
 * @mixin \Heritage\Contracts\Filesystem\Filesystem
 * @mixin \Heritage\Filesystem\FilesystemAdapter
 */
class FilesystemManager implements FactoryContract
{
     ...
     *
     * @return \Heritage\Contracts\Filesystem\Cloud
     */
