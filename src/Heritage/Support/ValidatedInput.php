...
use ArrayIterator;
use Heritage\Contracts\Support\ValidatedData;
use Heritage\Support\Traits\Dumpable;
use Heritage\Support\Traits\InteractsWithData;
use Traversable;
...
class ValidatedInput implements ValidatedData
{
     ...
     * @param  string  $key
     * @param  mixed  $default
     * @return \Heritage\Http\UploadedFile|null
     */
    public function file($key, $default = null)
    {
        $value = $this->input($key, $default);

        return $value instanceof \Heritage\Http\UploadedFile ? $value : $default;
    }
