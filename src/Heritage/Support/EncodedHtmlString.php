...
class EncodedHtmlString extends HtmlString
{
     ...
     * The HTML string.
     *
     * @var \Heritage\Contracts\Support\DeferringDisplayableValue|\Heritage\Contracts\Support\Htmlable|\BackedEnum|string|int|float|null
     */
    protected $html;
     ...
     *
     * @param  \Heritage\Contracts\Support\DeferringDisplayableValue|\Heritage\Contracts\Support\Htmlable|\BackedEnum|string|int|float|null  $html
