...
use Heritage\Contracts\Queue\Queue;
...
use Heritage\Queue\CallQueuedClosure;
use Heritage\Queue\Jobs\InspectedJob;
...
class QueueFake extends QueueManager implements Fake, Queue
{
     ...
     *
     * @var \Heritage\Contracts\Queue\Queue
     */
    public $queue;
     ...
     * @param  \Heritage\Queue\QueueManager|null  $queue
     */
     ...
     * @return \Heritage\Support\Collection<int, RawPushType>
     */
     ...
     * @param  (\Closure(mixed, \Heritage\Events\CallQueuedListener, string|null, mixed): bool)|null  $callback
     * @return \Heritage\Support\Collection<int, \Heritage\Events\CallQueuedListener>
     */
     ...
     *
     * @param  \UnitEnum|string|null  $queue
     * @return \Heritage\Support\Collection<int, \Heritage\Queue\Jobs\InspectedJob>
     */
     ...
     *
     * @param  \UnitEnum|string|null  $queue
     * @return \Heritage\Contracts\Queue\Job|null
     */
