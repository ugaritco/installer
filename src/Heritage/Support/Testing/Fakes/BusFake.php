...
class BusFake implements Fake, QueueingDispatcher
{
     ...
     *
     * @var \Heritage\Contracts\Bus\QueueingDispatcher
     */
    public $dispatcher;
     ...
     *
     * @var \Heritage\Bus\BatchRepository
     */
     ...
     *
     * @param  \Heritage\Contracts\Bus\QueueingDispatcher  $dispatcher
     ...
     * @return \Heritage\Support\Testing\Fakes\ChainedBatchTruthTest
     */
     ...
     *
     * @param  array|callable(\Heritage\Bus\PendingBatch): bool  $callback
     * @return void
     */
     ...
     *
     * @param  callable(\Heritage\Bus\PendingBatch): bool  $callback
     * @return \Heritage\Support\Collection<int, \Heritage\Bus\PendingBatch>
     */
     ...
     *
     * @param  \Heritage\Support\Collection|array|null  $jobs
