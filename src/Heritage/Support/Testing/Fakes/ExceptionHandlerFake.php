...
use Heritage\Foundation\Testing\Concerns\WithoutExceptionHandlingHandler;
...
/**
 * @mixin \Heritage\Foundation\Exceptions\Handler
 */
class ExceptionHandlerFake implements ExceptionHandler, Fake
{
     ...
     *
     * @param  \Heritage\Contracts\Debug\ExceptionHandler  $handler
     ...
     *
     * @return \Heritage\Contracts\Debug\ExceptionHandler
     */
