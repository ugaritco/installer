...
use Heritage\Support\Traits\Tappable;
...
class Stringable implements JsonSerializable, ArrayAccess, BaseStringable
{
     ...
     *
     * @param  \Heritage\Support\Stringable|string  $value
     * @return bool
     */
     ...
     * @param  int  $limit
     * @return \Heritage\Support\Collection<int, string>
     */
     ...
     *
     * @return \Heritage\Support\HtmlString
     */
