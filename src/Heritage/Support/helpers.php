...
use Heritage\Contracts\Support\DeferringDisplayableValue;
...
use Heritage\Support\HigherOrderTapProxy;
use Heritage\Support\Once;
use Heritage\Support\Onceable;
use Heritage\Support\Optional;
use Heritage\Support\Sleep;
use Heritage\Support\Str;
use Heritage\Support\Stringable as SupportStringable;
...
if (! function_exists('e')) {
     ...
     *
     * @param  \Heritage\Contracts\Support\DeferringDisplayableValue|\Heritage\Contracts\Support\Htmlable|\BackedEnum|string|int|float|null  $value
...
if (! function_exists('ugarit_cloud')) {
    /**
     * Determine if the application is running on Ugarit Cloud.
     */
    function ugarit_cloud(): bool
    {
        return ($_ENV['UGARIT_CLOUD'] ?? false) === '1' ||
            ($_SERVER['UGARIT_CLOUD'] ?? false) === '1';
    }
}
...
if (! function_exists('optional')) {
     ...
     * @return ($callback is null ? \Heritage\Support\Optional : ($value is null ? null : TReturn))
     */
...
if (! function_exists('str')) {
     ...
     * @return ($string is null ? object : \Heritage\Support\Stringable)
     */
...
if (! function_exists('tap')) {
     ...
     * @return ($callback is null ? \Heritage\Support\HigherOrderTapProxy<TValue> : TValue)
     */
