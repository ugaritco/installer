 ...
 * @method static \Heritage\Contracts\Queue\Queue connection(\UnitEnum|string|null $name = null)
 ...
 * @method static \Heritage\Queue\QueueManager setApplication(\Heritage\Contracts\Foundation\Application $app)
 ...
 * @method static \Heritage\Contracts\Queue\Job|null pop(string|null $queue = null)
 * @method static string getConnectionName()
 * @method static \Heritage\Contracts\Queue\Queue setConnectionName(string $name)
 ...
 * @method static \Heritage\Queue\Queue setConfig(array $config)
 * @method static \Heritage\Container\Container getContainer()
 * @method static void setContainer(\Heritage\Container\Container $container)
 * @method static \Heritage\Support\Testing\Fakes\QueueFake except(array|string $jobsToBeQueued)
 ...
 * @method static \Heritage\Support\Collection pushed(string $job, callable|null $callback = null)
 * @method static \Heritage\Support\Collection pushedRaw(null|\Closure $callback = null)
 * @method static \Heritage\Support\Collection listenersPushed(string $listenerClass, \Closure|null $callback = null)
 ...
 * @method static \Heritage\Support\Collection pendingJobs(\UnitEnum|string|null $queue = null)
 * @method static \Heritage\Support\Collection delayedJobs(\UnitEnum|string|null $queue = null)
 * @method static \Heritage\Support\Collection reservedJobs(\UnitEnum|string|null $queue = null)
 * @method static \Heritage\Support\Collection allPendingJobs()
 * @method static \Heritage\Support\Collection allDelayedJobs()
 * @method static \Heritage\Support\Collection allReservedJobs()
 ...
 * @method static \Heritage\Support\Testing\Fakes\QueueFake serializeAndRestore(bool $serializeAndRestore = true)
 * @method static void releaseUniqueJobLocks()
 * @method static void clearReserved()
 * @method static \Heritage\Support\Testing\Fakes\QueueFake beforePushing(callable $callback)
 * @method static \Heritage\Support\Testing\Fakes\QueueFake afterPushing(callable $callback)
 *
 * @see \Heritage\Queue\QueueManager
 * @see \Heritage\Queue\Queue
 * @see \Heritage\Support\Testing\Fakes\QueueFake
 */
class Queue extends Facade
{
     ...
     * @return \Heritage\Support\Testing\Fakes\QueueFake
     */
