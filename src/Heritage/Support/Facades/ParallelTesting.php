 ...
 * @method static void callSetUpTestCaseCallbacks(\Heritage\Foundation\Testing\TestCase $testCase)
 ...
 * @method static void callTearDownTestCaseCallbacks(\Heritage\Foundation\Testing\TestCase $testCase)
 * @method static mixed option(string $option)
 * @method static string|false token()
 *
 * @see \Heritage\Testing\ParallelTesting
 */
class ParallelTesting extends Facade
{
    ...
    {
        return \Heritage\Testing\ParallelTesting::class;
    }
}
