...
/**
 * @method static void listen(\Heritage\Events\QueuedClosure|callable|array|string $events, \Heritage\Events\QueuedClosure|callable|array|string|null $listener = null)
 ...
 * @method static \Heritage\Events\Dispatcher setQueueResolver(callable $resolver)
 * @method static \Heritage\Events\Dispatcher setTransactionManagerResolver(callable $resolver)
 ...
 * @method static \Heritage\Support\Testing\Fakes\EventFake except(array|string $eventsToDispatch)
 ...
 * @method static \Heritage\Support\Collection dispatched(string $event, callable|null $callback = null)
 * @method static bool hasDispatched(string $event)
 * @method static array dispatchedEvents()
 *
 * @see \Heritage\Events\Dispatcher
 * @see \Heritage\Support\Testing\Fakes\EventFake
 */
class Event extends Facade
{
     ...
     * @return \Heritage\Support\Testing\Fakes\EventFake
     */
