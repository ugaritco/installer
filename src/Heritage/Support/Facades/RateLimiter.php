...
/**
 * @method static \Heritage\Cache\RateLimiter for(\UnitEnum|string $name, \Closure $callback)
 ...
 *
 * @see \Heritage\Cache\RateLimiter
 */
class RateLimiter extends Facade
{
    ...
    {
        return \Heritage\Cache\RateLimiter::class;
    }
}
