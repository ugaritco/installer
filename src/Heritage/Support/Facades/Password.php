...
/**
 * @method static \Heritage\Contracts\Auth\PasswordBroker broker(\UnitEnum|string|null $name = null)
 * @method static string getDefaultDriver()
 * @method static void setDefaultDriver(\UnitEnum|string $name)
 * @method static string sendResetLink(array $credentials, \Closure|null $callback = null)
 * @method static mixed reset(array $credentials, \Closure $callback)
 * @method static \Heritage\Contracts\Auth\CanResetPassword|null getUser(array $credentials)
 * @method static string createToken(\Heritage\Contracts\Auth\CanResetPassword $user)
 * @method static void deleteToken(\Heritage\Contracts\Auth\CanResetPassword $user)
 * @method static bool tokenExists(\Heritage\Contracts\Auth\CanResetPassword $user, string $token)
 * @method static \Heritage\Auth\Passwords\TokenRepositoryInterface getRepository()
 * @method static \Heritage\Support\Timebox getTimebox()
 *
 * @see \Heritage\Auth\Passwords\PasswordBrokerManager
 * @see \Heritage\Auth\Passwords\PasswordBroker
 */
