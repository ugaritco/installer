...
/**
 * @method static \Heritage\Redis\Connections\Connection connection(\UnitEnum|string|null $name = null)
 * @method static \Heritage\Redis\Connections\Connection resolve(string|null $name = null)
 ...
 * @method static \Heritage\Redis\RedisManager extend(string $driver, \Closure $callback)
 * @method static void createSubscription(array|string $channels, \Closure $callback, string $method = 'subscribe')
 * @method static \Heritage\Redis\Limiters\ConcurrencyLimiterBuilder funnel(string $name)
 * @method static \Heritage\Redis\Limiters\DurationLimiterBuilder throttle(string $name)
 ...
 * @method static \Heritage\Redis\Connections\Connection setName(string $name)
 ...
 *
 * @see \Heritage\Redis\RedisManager
 */
