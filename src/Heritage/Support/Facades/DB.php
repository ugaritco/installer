...
use Heritage\Database\Console\Migrations\FreshCommand;
use Heritage\Database\Console\Migrations\RefreshCommand;
use Heritage\Database\Console\Migrations\ResetCommand;
use Heritage\Database\Console\Migrations\RollbackCommand;
use Heritage\Database\Console\WipeCommand;

/**
 * @method static \Heritage\Database\Connection connection(\UnitEnum|string|null $name = null)
 * @method static \Heritage\Database\ConnectionInterface build(array $config)
 * @method static string calculateDynamicConnectionName(array $config)
 * @method static \Heritage\Database\ConnectionInterface connectUsing(\UnitEnum|string $name, array $config, bool $force = false)
 * @method static void purge(\UnitEnum|string|null $name = null)
 * @method static void disconnect(\UnitEnum|string|null $name = null)
 * @method static \Heritage\Database\Connection reconnect(\UnitEnum|string|null $name = null)
 ...
 * @method static \Heritage\Database\DatabaseManager setApplication(\Heritage\Contracts\Foundation\Application $app)
 ...
 * @method static \Heritage\Database\Schema\Builder getSchemaBuilder()
 * @method static \Heritage\Database\Query\Builder table(\Closure|\Heritage\Database\Query\Builder|\Heritage\Contracts\Database\Query\Expression|\UnitEnum|string $table, string|null $as = null)
 * @method static \Heritage\Database\Query\Builder query()
 ...
 * @method static \Heritage\Database\Connection beforeStartingTransaction(\Closure $callback)
 * @method static \Heritage\Database\Connection beforeExecuting(\Closure $callback)
 * @method static void listen(\Closure $callback)
 * @method static \Heritage\Contracts\Database\Query\Expression raw(mixed|int|float $value)
 ...
 * @method static \Heritage\Database\Connection setRecordModificationState(bool $value)
 * @method static void forgetRecordModificationState()
 * @method static \Heritage\Database\Connection useWriteConnectionWhenReading(bool $value = true)
 ...
 * @method static \Heritage\Database\Connection setPdo(\PDO|\Closure|null $pdo)
 * @method static \Heritage\Database\Connection setReadPdo(\PDO|\Closure|null $pdo)
 * @method static \Heritage\Database\Connection setReadPdoConfig(array $config)
 * @method static \Heritage\Database\Connection setDirectPdo(\PDO|\Closure|null $pdo)
 * @method static \Heritage\Database\Connection setDirectPdoConfig(array $config)
 ...
 * @method static \Heritage\Database\Query\Grammars\Grammar getQueryGrammar()
 * @method static \Heritage\Database\Connection setQueryGrammar(\Heritage\Database\Query\Grammars\Grammar $grammar)
 * @method static \Heritage\Database\Schema\Grammars\Grammar getSchemaGrammar()
 * @method static \Heritage\Database\Connection setSchemaGrammar(\Heritage\Database\Schema\Grammars\Grammar $grammar)
 * @method static \Heritage\Database\Query\Processors\Processor getPostProcessor()
 * @method static \Heritage\Database\Connection setPostProcessor(\Heritage\Database\Query\Processors\Processor $processor)
 * @method static \Heritage\Contracts\Events\Dispatcher|null getEventDispatcher()
 * @method static \Heritage\Database\Connection setEventDispatcher(\Heritage\Contracts\Events\Dispatcher $events)
 * @method static void unsetEventDispatcher()
 * @method static \Heritage\Database\Connection setTransactionManager(\Heritage\Database\DatabaseTransactionsManager $manager)
 ...
 * @method static \Heritage\Database\Connection setDatabaseName(string $database)
 * @method static \Heritage\Database\Connection setReadWriteType(string|null $readWriteType)
 * @method static string getTablePrefix()
 * @method static \Heritage\Database\Connection setTablePrefix(string $prefix)
 ...
 *
 * @see \Heritage\Database\DatabaseManager
 */
class DB extends Facade
{
    /**
     * Indicate if destructive Scribe commands should be prohibited.
     *
