...
/**
 * @method static \Heritage\Foundation\Configuration\ApplicationBuilder configure(string|null $basePath = null)
 ...
 * @method static \Heritage\Foundation\Application setBasePath(string $basePath)
 * @method static string path(string $path = '')
 * @method static \Heritage\Foundation\Application useAppPath(string $path)
 * @method static string basePath(string $path = '')
 * @method static string bootstrapPath(string $path = '')
 * @method static string getBootstrapProvidersPath()
 * @method static \Heritage\Foundation\Application useBootstrapPath(string $path)
 * @method static string configPath(string $path = '')
 * @method static \Heritage\Foundation\Application useConfigPath(string $path)
 * @method static string databasePath(string $path = '')
 * @method static \Heritage\Foundation\Application useDatabasePath(string $path)
 * @method static string langPath(string $path = '')
 * @method static \Heritage\Foundation\Application useLangPath(string $path)
 * @method static string publicPath(string $path = '')
 * @method static \Heritage\Foundation\Application usePublicPath(string $path)
 * @method static string storagePath(string $path = '')
 * @method static \Heritage\Foundation\Application useStoragePath(string $path)
 * @method static string resourcePath(string $path = '')
 * @method static string viewPath(string $path = '')
 * @method static string joinPaths(string $basePath, string $path = '')
 * @method static string environmentPath()
 * @method static \Heritage\Foundation\Application useEnvironmentPath(string $path)
 * @method static \Heritage\Foundation\Application loadEnvironmentFrom(string $file)
 ...
 * @method static \Heritage\Support\ServiceProvider register(\Heritage\Support\ServiceProvider|string $provider, bool $force = false)
 * @method static \Heritage\Support\ServiceProvider|null getProvider(\Heritage\Support\ServiceProvider|string $provider)
 * @method static array getProviders(\Heritage\Support\ServiceProvider|string $provider)
 * @method static \Heritage\Support\ServiceProvider resolveProvider(string $provider)
 ...
 * @method static void handleRequest(\Heritage\Http\Request $request)
 ...
 * @method static \Heritage\Foundation\Application dontMergeFrameworkConfiguration()
 ...
 * @method static \Heritage\Foundation\Application addAbsoluteCachePathPrefix(string $prefix)
 * @method static \Heritage\Contracts\Foundation\MaintenanceMode maintenanceMode()
 * @method static bool isDownForMaintenance()
 * @method static never abort(int $code, string $message = '', array $headers = [])
 * @method static \Heritage\Foundation\Application terminating(callable|string $callback)
 ...
 * @method static \Heritage\Contracts\Container\ContextualBindingBuilder when(array|string $concrete)
 ...
 * @method static \Heritage\Foundation\Application getInstance()
 * @method static \Heritage\Contracts\Container\Container|\Heritage\Foundation\Application setInstance(\Heritage\Contracts\Container\Container|null $container = null)
 * @method static void macro(string $name, object|callable $macro)
 * @method static void mixin(object $mixin, bool $replace = true)
 * @method static bool hasMacro(string $name)
 * @method static void flushMacros()
 *
 * @see \Heritage\Foundation\Application
 */
