...
/**
 * @method static \Heritage\Contracts\View\View file(string $path, \Heritage\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static \Heritage\Contracts\View\View make(string $view, \Heritage\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static \Heritage\Contracts\View\View first(array $views, \Heritage\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static string renderWhen(bool $condition, string $view, \Heritage\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static string renderUnless(bool $condition, string $view, \Heritage\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static string renderEach(string $view, array $data, string $iterator, string $empty = 'raw|')
 * @method static bool exists(string $view)
 * @method static \Heritage\Contracts\View\Engine getEngineFromPath(string $path)
 ...
 * @method static \Heritage\View\Factory addNamespace(string $namespace, string|array $hints)
 * @method static \Heritage\View\Factory prependNamespace(string $namespace, string|array $hints)
 * @method static \Heritage\View\Factory replaceNamespace(string $namespace, string|array $hints)
 ...
 * @method static \Heritage\View\Engines\EngineResolver getEngineResolver()
 * @method static \Heritage\View\ViewFinderInterface getFinder()
 * @method static void setFinder(\Heritage\View\ViewFinderInterface $finder)
 ...
 * @method static void setContainer(\Heritage\Contracts\Container\Container $container)
 ...
 * @method static void startComponent(\Heritage\Contracts\View\View|\Heritage\Contracts\Support\Htmlable|\Closure|string $view, array $data = [])
 ...
 * @method static void callComposer(\Heritage\Contracts\View\View $view)
 * @method static void callCreator(\Heritage\Contracts\View\View $view)
