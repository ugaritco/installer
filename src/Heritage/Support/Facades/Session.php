 ...
 * @method static \Heritage\Session\SessionManager extend(string $driver, \Closure $callback)
 * @method static array getDrivers()
 * @method static \Heritage\Contracts\Container\Container getContainer()
 * @method static \Heritage\Session\SessionManager setContainer(\Heritage\Contracts\Container\Container $container)
 * @method static \Heritage\Session\SessionManager forgetDrivers()
 ...
 * @method static \Heritage\Contracts\Cache\Repository cache()
 ...
 * @method static \Heritage\Support\Uri previousUri()
 ...
 * @method static void setRequestOnHandler(\Heritage\Http\Request $request)
 * @method static void macro(string $name, object|callable $macro)
 * @method static void mixin(object $mixin, bool $replace = true)
 * @method static bool hasMacro(string $name)
 * @method static void flushMacros()
 *
 * @see \Heritage\Session\SessionManager
 */
