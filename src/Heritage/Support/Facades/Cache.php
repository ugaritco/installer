...
/**
 * @method static \Heritage\Contracts\Cache\Repository store(\UnitEnum|string|null $name = null)
 * @method static \Heritage\Contracts\Cache\Repository driver(\UnitEnum|string|null $driver = null)
 * @method static \Heritage\Contracts\Cache\Repository memo(\UnitEnum|string|null $driver = null)
 * @method static \Heritage\Contracts\Cache\Repository resolve(string $name)
 * @method static \Heritage\Cache\Repository build(array $config)
 * @method static \Heritage\Cache\Repository repository(\Heritage\Contracts\Cache\Store $store, array $config = [])
 * @method static void refreshEventDispatcher()
 * @method static string getDefaultDriver()
 * @method static void setDefaultDriver(\UnitEnum|string $name)
 * @method static \Heritage\Cache\CacheManager forgetDriver(array|\UnitEnum|string|null $name = null)
 * @method static void purge(\UnitEnum|string|null $name = null)
 * @method static \Heritage\Cache\CacheManager extend(string $driver, \Closure $callback)
 * @method static \Heritage\Cache\CacheManager setApplication(\Heritage\Contracts\Foundation\Application $app)
 ...
 * @method static \Heritage\Cache\Limiters\ConcurrencyLimiterBuilder funnel(\UnitEnum|string $name)
 ...
 * @method static \Heritage\Cache\TaggedCache tags(mixed $names)
 * @method static string|null getName()
 * @method static bool supportsTags()
 * @method static bool supportsFlushingLocks()
 * @method static int|null getDefaultCacheTime()
 * @method static \Heritage\Cache\Repository setDefaultCacheTime(int|null $seconds)
 * @method static \Heritage\Contracts\Cache\Store getStore()
 * @method static \Heritage\Cache\Repository setStore(\Heritage\Contracts\Cache\Store $store)
 * @method static \Heritage\Contracts\Events\Dispatcher|null getEventDispatcher()
 * @method static void setEventDispatcher(\Heritage\Contracts\Events\Dispatcher $events)
 ...
 * @method static \Heritage\Contracts\Cache\Lock lock(string $name, int $seconds = 0, string|null $owner = null)
 * @method static \Heritage\Contracts\Cache\Lock restoreLock(string $name, string $owner)
 *
 * @see \Heritage\Cache\CacheManager
 * @see \Heritage\Cache\Repository
 */
