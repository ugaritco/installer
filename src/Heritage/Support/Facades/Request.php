...
/**
 * @method static \Heritage\Http\Request capture()
 * @method static \Heritage\Http\Request instance()
 * @method static string method()
 * @method static \Heritage\Support\Uri uri()
 ...
 * @method static \Heritage\Http\Request merge(array $input)
 * @method static \Heritage\Http\Request mergeIfMissing(array $input)
 * @method static \Heritage\Http\Request replace(array $input)
 * @method static \Symfony\Component\HttpFoundation\InputBag|mixed json(string|null $key = null, mixed $default = null)
 * @method static \Heritage\Http\Request createFrom(\Heritage\Http\Request $from, \Heritage\Http\Request|null $to = null)
 * @method static \Heritage\Http\Request createFromBase(\Symfony\Component\HttpFoundation\Request $request)
 * @method static \Heritage\Http\Request duplicate(array|null $query = null, array|null $request = null, array|null $attributes = null, array|null $cookies = null, array|null $files = null, array|null $server = null)
 ...
 * @method static \Heritage\Contracts\Session\Session session()
 * @method static void setUgaritSession(\Heritage\Contracts\Session\Session $session)
 * @method static void setRequestLocale(string $locale)
 * @method static void setDefaultRequestLocale(string $locale)
 * @method static mixed user(string|null $guard = null)
 * @method static \Heritage\Routing\Route|object|string|null route(string|null $param = null, mixed $default = null)
 * @method static string fingerprint()
 * @method static \Heritage\Http\Request setJson(\Symfony\Component\HttpFoundation\InputBag $json)
 * @method static \Closure getUserResolver()
 * @method static \Heritage\Http\Request setUserResolver(\Closure $callback)
 * @method static \Closure getRouteResolver()
 * @method static \Heritage\Http\Request setRouteResolver(\Closure $callback)
 ...
 * @method static \Heritage\Http\Request createFromGlobals()
 * @method static \Heritage\Http\Request create(string $uri, string $method = 'GET', array $parameters = [], array $cookies = [], array $files = [], array $server = [], string|resource|null $content = null)
 ...
 * @method static string|array|null old(string|null $key = null, \Heritage\Database\Eloquent\Model|string|array|null $default = null)
 ...
 * @method static \Heritage\Support\Fluent fluent(array|string|null $key = null, array $default = [])
 ...
 * @method static array|\Heritage\Http\UploadedFile|\Heritage\Http\UploadedFile[]|null file(string|null $key = null, mixed $default = null)
 * @method static \Heritage\Image\Image|null image(string $key)
 * @method static \Heritage\Http\Request dump(mixed $keys = [])
 * @method static never dd(mixed ...$args)
 * @method static bool exists(string|array $key)
 * @method static bool has(string|array $key)
 * @method static bool hasAny(string|array $keys)
 * @method static \Heritage\Http\Request|mixed whenHas(string $key, callable $callback, callable|null $default = null)
 ...
 * @method static \Heritage\Http\Request|mixed whenFilled(string $key, callable $callback, callable|null $default = null)
 * @method static \Heritage\Http\Request|mixed whenEnum(string $key, string $enumClass, callable $callback, callable|null $default = null)
 * @method static bool missing(string|array $key)
 * @method static \Heritage\Http\Request|mixed whenMissing(string $key, callable $callback, callable|null $default = null)
 * @method static \Heritage\Support\Stringable str(string $key, mixed $default = null)
 * @method static \Heritage\Support\Stringable string(string $key, mixed $default = null)
 ...
 * @method static \Heritage\Support\Carbon|null date(string $key, string|null $format = null, \UnitEnum|string|null $tz = null)
 ...
 * @method static \Heritage\Support\Collection collect(array|string|null $key = null)
 * @method static array only(mixed $keys)
 * @method static array except(mixed $keys)
 * @method static \Heritage\Http\Request|mixed when(\Closure|mixed|null $value = null, callable|null $callback = null, callable|null $default = null)
 * @method static \Heritage\Http\Request|mixed unless(\Closure|mixed|null $value = null, callable|null $callback = null, callable|null $default = null)
