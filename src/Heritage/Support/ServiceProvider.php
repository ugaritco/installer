...
use Heritage\Contracts\Foundation\CachesConfiguration;
use Heritage\Contracts\Foundation\CachesRoutes;
use Heritage\Contracts\Support\DeferrableProvider;
use Heritage\Database\Eloquent\Factory as ModelFactory;
...
abstract class ServiceProvider
{
    ...
    /**
     * Register the package's custom Scribe commands.
     *
    ...
    public function commands($commands)
    {
        ...
        Scribe::starting(function ($scribe) use ($commands) {
            $scribe->resolveCommands($commands);
        });
    }
    ...
    /**
     * Get the default providers for a Ugarit application.
     *
     * @return \Heritage\Support\DefaultProviders
     */
