...
use Heritage\Contracts\Support\MessageProvider;
...
class MessageBag implements Jsonable, JsonSerializable, MessageBagContract, MessageProvider, Stringable
{
     ...
     *
     * @param  \Heritage\Contracts\Support\MessageProvider|array<string, array<string>>  $messages
     * @return $this
     */
     ...
     *
     * @return \Heritage\Support\MessageBag
     */
